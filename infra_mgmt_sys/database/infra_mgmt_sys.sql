...
INSERT INTO `tickets` (`id`, `uniqid`, `user`, `title`, `init_msg`, `department`, `date`, `last_reply`, `user_read`, `admin_read`, `resolved`) VALUES
...
INSERT INTO `users` (`id`, `email`, `password`, `create_date`, `name`, `user_type`, `status`) VALUES
