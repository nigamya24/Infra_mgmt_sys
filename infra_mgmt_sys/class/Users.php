...
class Users extends Database { 
	...
	public function listUser(){
		...
		$sqlQuery = "SELECT id, name, email, create_date, user_type, status, contact, department 
			FROM ".$this->userTable;
		...
		while( $user = mysqli_fetch_assoc($result) ) {		
			...
			if($user['user_type'] == 'admin')	{
				...
				$userRole = '<span class="label label-warning">Customer</span>';
			}	
			
			$userRows[] = $user['id'];
			$userRows[] = $user['name'];
			$userRows[] = $user['email'];
			$userRows[] = $user['contact'];
	...
	public function getUserDetails(){		
		if($this->id) {		
			$sqlQuery = "SELECT id, name, email, user_type, contact, department FROM ".$this->userTable." WHERE id = '".$this->id."'";
			$result = mysqli_query($this->dbConnect, $sqlQuery);	
	...
	public function insert() {      
		if($this->userName && $this->email) {		              
			...
			$queryInsert = "
				INSERT INTO ".$this->userTable."(name, email, user_type, status, password, contact, department) VALUES(
				'".$this->userName."', '".$this->email."', '".$this->role."','".$this->status."', '".$this->newPassword."', '".$_POST['contact_no']."', '".$_POST['department']."')";				
	...
	public function update() {      
		if($this->updateUserId && $this->userName) {		              
			...
			$queryUpdate = "
				...
				SET name = '".$this->userName."', email = '".$this->email."', user_type = '".$this->role."', contact = '".$_POST['contact_no']."', department = '".$_POST['department']."', status = '".$this->status."' $changePassword
